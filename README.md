...
- **`clasificacion.py`**: 
  - Extrae características de las señales, calcula el puntaje de Fisher y entrena modelos de Machine Learning (Árboles de Decisión y Naive Bayes).
  - Genera el archivo: `Verificacion_WESAD_Fisher.xlsx` y gráficas comparativas de precisión.

- **`general_suj.py`**: 
  - Realiza análisis exploratorio (EDA) y selección de características (Fisher Score y Forward Selection) de forma global y por sujeto.
  - Genera el reporte: `Reporte_Final_WESAD.pdf` y visualizaciones de correlación.
